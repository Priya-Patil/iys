...
public class MessListChargesActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mess_list_charges);
        prefManager=new PrefManager(MessListChargesActivity.this);
        Toast.makeText(getApplicationContext(), "ppppp"+prefManager.getMOBILE_SELECTED(), Toast.LENGTH_LONG).show();


        setTitle("Mess List Charges");
        ...
        findViewById(R.id.btn_save_excel).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveExcelFile(MessListChargesActivity.this, "mess_charges.xls");
            }
        });
    }
    ...
    private void setBooking(final String typeName, final String typeCharge)
    {
        //-----------Set date----------------
...

        {
            ...
            final ProgressDialog loading = ProgressDialog.show(MessListChargesActivity.this,"Uploading...","Please wait...",false,false);
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("typeCharge",typeCharge);
    ...
    private boolean saveExcelFile(Context context, String fileName) {
        ...
        //New Sheet
        Sheet sheet1 = null;
        sheet1 = wb.createSheet("Mess Charges List");

        // Generate column headings
        Row row = sheet1.createRow(0);

        c = row.createCell(0);
        c.setCellValue("Mess Name");
        c.setCellStyle(cs);

        c = row.createCell(1);
        c.setCellValue("Type Name");
        c.setCellStyle(cs);
        ...
        for (int i = 0; i < chargesList.size(); i++){
            ...
            c.setCellValue(chargesList.get(i).get("type_name"));
            c.setCellStyle(cs);

            c = contentRow.createCell(2);
            c.setCellValue(chargesList.get(i).get("type_charge"));
            c.setCellStyle(cs);
        ...
        try {
            ...
            Toast.makeText(MessListChargesActivity.this, "Writing file" + file, Toast.LENGTH_LONG).show();
            success = true;
        } catch (IOException e) {
            Log.w("FileUtils", "Error writing " + file, e);
            Toast.makeText(MessListChargesActivity.this, "Error writing " + file, Toast.LENGTH_LONG).show();
        } catch (Exception e) {
            Log.w("FileUtils", "Failed to save file", e);
            Toast.makeText(MessListChargesActivity.this, "Failed to save file", Toast.LENGTH_LONG).show();
        } finally {
            try {
                if (null != os)
                    os.close();
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    table = (TableLayout) findViewById(R.id.tl_types_data);
                    ...
                    ((TextView) row.findViewById(R.id.tv_name)).setText("Mess Name");
                    ((TextView) row.findViewById(R.id.tv_sub_name)).setText("Type Name");
                    ...
                    for (int i = 0; i < responseArr.length(); i++) {
                        ...
                        ((TextView) row.findViewById(R.id.tv_sub_name)).setText(obj.getString("type_name"));
                        ((TextView) row.findViewById(R.id.tv_rate)).setText(obj.getString("type_charge"));
                        ...
                        aSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                            ...
                            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                                if (isChecked){
                                    ...
                                    messId = chargesList.get(table.indexOfChild(tableRow) -1).get("messId");
                                    String typeName = chargesList.get(table.indexOfChild(tableRow) -1).get("type_name");
                                    String typeCharge = chargesList.get(table.indexOfChild(tableRow) -1).get("type_charge");
                                    setBooking(typeName, typeCharge);
                                }else {
                        ...
                        listItem.put("type_name", obj.getString("type_name"));
                        listItem.put("type_charge", obj.getString("type_charge"));
