...
public class SubPaymentHistoryActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefManager = new PrefManager(SubPaymentHistoryActivity.this);
    ...
    private  void setAllVehicleForUser(final  String userid, final  String type)
    {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                {
                    ViewAllVehicleAdapter viewStaffAdapter = new ViewAllVehicleAdapter(SubPaymentHistoryActivity.this,vehicleList);
