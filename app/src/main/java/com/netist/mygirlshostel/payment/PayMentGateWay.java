...
public class PayMentGateWay extends Activity {
   ...
   //  String merchant_key="kYz2vV"; // test
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefManager =new PrefManager(PayMentGateWay.this);
...
*/
    ...
    public void addPayment(final String userid, final String type,
                               final String amount) {

        String tag_string_req = "TotalStaffRequest";
        final ProgressDialog loading = ProgressDialog.show(PayMentGateWay.this, "", "Please wait...", false, false);

        StringRequest strReq = new StringRequest(Request.Method.POST,
                urlpayment, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                  ...
                  //  Toast.makeText(activity, user_id, Toast.LENGTH_SHORT).show();
                    ...
                    Intent startActivityIntent = new Intent(PayMentGateWay.this, MainActivity.class);
            ...
            protected Map<String, String> getParams() {
                //vname`, `vno`, `rcno`, `noofseat`,`source`,`destination`
                Map<String, String> params = new HashMap<String, String>();
                params.put("action", "add_payment");
