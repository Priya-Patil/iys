...
public class ClassesBookingListAdapter extends BaseAdapter {
    ...
    public ClassesBookingListAdapter(Activity activity, ArrayList<HashMap<String,String>> bookingList) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_layout_classes_booking, null);
        ...
        TextView tv_classes_name = (TextView) convertView.findViewById(R.id.tv_classes_name);
        TextView tv_batch_name = (TextView) convertView.findViewById(R.id.tv_batch_name);
        ...
        String classesName = m.get("classesName");
        if (!classesName.equals(""))
        {
            tv_classes_name.setVisibility(View.VISIBLE);
            tv_classes_name.setText(classesName);
        }

        String batchName = m.get("batchName");
        if (!batchName.equals(""))
        {
            tv_batch_name.setVisibility(View.VISIBLE);
            tv_batch_name.setText(batchName);
        }
        ...
        if(session.getUserType().trim().equals("classes"))
            tv_classes_name.setVisibility(View.GONE);
