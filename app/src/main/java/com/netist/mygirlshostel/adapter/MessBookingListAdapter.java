...
public class MessBookingListAdapter extends BaseAdapter {
    ...
    public MessBookingListAdapter(Activity activity, ArrayList<HashMap<String,String>> bookingList) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_layout_mess_booking, null);
        ...
        TextView tv_mess_name = (TextView) convertView.findViewById(R.id.tv_mess_name);
        ...
        String messName = m.get("messName");
        if (!messName.equals(""))
        {
            tv_mess_name.setVisibility(View.VISIBLE);
            tv_mess_name.setText(messName);
        }
        ...
        if(session.getUserType().trim().equals("mess"))
            tv_mess_name.setVisibility(View.GONE);
