...
public class ViewListAdapter   extends BaseAdapter {
    ...
    public ViewListAdapter(Activity activity, ArrayList<HashMap<String, String>> noticeList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        thumbNail.setImageUrl(ApiConfig.urlViewImage + images[0], imageLoader);
