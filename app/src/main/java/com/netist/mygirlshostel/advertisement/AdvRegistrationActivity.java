...
public class AdvRegistrationActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void dialogForConfirmOTP ( ){
        ...
        resultbox = new Dialog(AdvRegistrationActivity.this);
        ...
        btn_finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utility.isNetworkAvailable(AdvRegistrationActivity.this)) {

                    /**********Delete Code****************/
                    if(et_otp.getText().toString().equals(""))
                    {
                        Toast.makeText(AdvRegistrationActivity.this, "Enter OTP", Toast.LENGTH_SHORT).show();
                        ...
                        {
                            Toast.makeText(AdvRegistrationActivity.this, "Enter proper OTP", Toast.LENGTH_SHORT).show();
                        }
                    }
                } else {

                    Toast.makeText(AdvRegistrationActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        ...
        if(name.equals("") || address.equals("") || mobile.equals("") || password.equals("") || vpassword.equals("") )
        {
            ...
            else
            {
                ...
                StringRequest strReq = new StringRequest(Request.Method.POST,
                        ApiConfig.urladv_reg, new Response.Listener<String>() {
    ...
    private void RegisterChatUser(String id, final String name, final String mobile)
    {
           ...
           StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>(){
                ...
                public void onResponse(String s) {
                    ...
                    if(s.equals("null")) {
                        ...
                        Toast.makeText(AdvRegistrationActivity.this, "Chat Enabled", Toast.LENGTH_SHORT).show();
                    }
                    else {
                        try {
                            ...
                            if (!obj.has(mobile)) {
                                ...
                                Toast.makeText(AdvRegistrationActivity.this, "Chat Disabled", Toast.LENGTH_SHORT).show();
                            }
            ...
            RequestQueue rQueue = Volley.newRequestQueue(AdvRegistrationActivity.this);
            rQueue.add(request);


            session.setLogin(true);
            session.setUserType("adv");
        ...
        Intent intent = new Intent(AdvRegistrationActivity.this, AdvHomeActivity.class);
            ...
            AdvRegistrationActivity.this.finish();
