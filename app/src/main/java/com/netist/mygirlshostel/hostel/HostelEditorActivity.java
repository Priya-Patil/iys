...
public class HostelEditorActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void ShowImageChooser() {
        final CharSequence[] items = {"Take Photo", "Choose from Library",
                "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(HostelEditorActivity.this);
...
//        final ProgressDialog loading = ProgressDialog.show(this,null,"Loading List, Please wait...",false,false);
    ...
    private void RegisterChatUser(final String name, final String mobile)
    {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                if (s.equals("null")) {
                    ...
                    Toast.makeText(HostelEditorActivity.this, "Chat Enabled", Toast.LENGTH_SHORT).show();
                } else {
                    try {
                        ...
                        if (!obj.has(mobile)) {
                            ...
                            Toast.makeText(HostelEditorActivity.this, "Chat Disabled", Toast.LENGTH_SHORT).show();
                        }
        ...
        RequestQueue rQueue = Volley.newRequestQueue(HostelEditorActivity.this);
        rQueue.add(request);
