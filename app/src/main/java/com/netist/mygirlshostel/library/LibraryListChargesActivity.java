...
public class LibraryListChargesActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_library_list_charges);
        prefManager=new PrefManager(LibraryListChargesActivity.this);
        Toast.makeText(getApplicationContext(), "ppppp"+prefManager.getMOBILE_SELECTED(), Toast.LENGTH_LONG).show();
        setTitle("Library List Charges");
        ...
        findViewById(R.id.btn_save_excel).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveExcelFile(LibraryListChargesActivity.this, "library_charges.xls");
            }
        });
    }
    ...
    private boolean saveExcelFile(Context context, String fileName) {
        ...
        //New Sheet
        Sheet sheet1 = null;
        sheet1 = wb.createSheet("Library Charges List");

        // Generate column headings
        Row row = sheet1.createRow(0);

        c = row.createCell(0);
        c.setCellValue("Library Name");
        c.setCellStyle(cs);

        c = row.createCell(1);
        c.setCellValue("Hall Name");
        c.setCellStyle(cs);
        ...
        for (int i = 0; i < chargesList.size(); i++){
            ...
            c.setCellValue(chargesList.get(i).get("h_name"));
            c.setCellStyle(cs);
        ...
        try {
            ...
            Toast.makeText(LibraryListChargesActivity.this, "Writing file" + file, Toast.LENGTH_LONG).show();
            success = true;
        } catch (IOException e) {
            Log.w("FileUtils", "Error writing " + file, e);
            Toast.makeText(LibraryListChargesActivity.this, "Error writing " + file, Toast.LENGTH_LONG).show();
        } catch (Exception e) {
            Log.w("FileUtils", "Failed to save file", e);
            Toast.makeText(LibraryListChargesActivity.this, "Failed to save file", Toast.LENGTH_LONG).show();
        } finally {
            try {
                if (null != os)
                    os.close();
    ...
    private void setBooking(final String hallName)
    {
        //-----------Set date----------------
...

        {
            ...
            final ProgressDialog loading = ProgressDialog.show(LibraryListChargesActivity.this,"Uploading...","Please wait...",false,false);
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    table = (TableLayout) findViewById(R.id.tl_halls_data);
                    ...
                    ((TextView) row.findViewById(R.id.tv_name)).setText("Library Name");
                    ((TextView) row.findViewById(R.id.tv_sub_name)).setText("Hall Name");
                    ...
                    for (int i = 0; i < responseArr.length(); i++) {
                        ...
                        ((TextView) row.findViewById(R.id.tv_sub_name)).setText(obj.getString("h_name"));
                        ((TextView) row.findViewById(R.id.tv_rate)).setText(obj.getString("charges"));
                        ((TextView) row.findViewById(R.id.tv_availability)).setText(obj.getString("h_availability"));
                        ...
                        aSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                            ...
                            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                                if (isChecked){
                                    ...
                                    libraryId = chargesList.get(table.indexOfChild(tableRow) -1).get("libraryId");
                                    String hallName = chargesList.get(table.indexOfChild(tableRow) -1).get("h_name");
                                    setBooking(hallName);
                                }else {
                        ...
                        listItem.put("h_name", obj.getString("h_name"));
                        listItem.put("charges", obj.getString("charges"));
                        listItem.put("availability", obj.getString("h_availability"));
